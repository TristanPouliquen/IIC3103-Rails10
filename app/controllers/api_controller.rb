...
# Functions to process the data and decide to accept or reject
  def processPurchaseOrder(idOc)
    ...
    if purchaseOrder.nil? or purchaseOrder.empty?
      ...
      if !record.nil?
        ...
        OrdenCompra.create idOC: idOc.to_s, proveedor: purchaseOrder['proveedor'], cliente: purchaseOrder['cliente'], monto: (purchaseOrder['precioUnitario']* purchaseOrder['cantidad']), canal: purchaseOrder['canal'], cantidad: purchaseOrder['cantidad'], cantidad_despachada: purchaseOrder['cantidadDespachada'], estado: purchaseOrder['estado']
  ...
  def processBill(idBill)
    ...
    if bill.nil? or bill.empty?
      ...
      Factura.create idFactura: idBill.to_s, proveedor: bill['proveedor'], cliente: bill['cliente'], monto: bill['total'], estado: bill['estado'], idOc: bill['oc']
